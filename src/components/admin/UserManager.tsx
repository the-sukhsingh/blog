    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground hover:bg-primary/90 transition-all cursor-pointer active:translate-y-px"
        >
          <Plus size={13} />
          Create User
        </button>
                ...
                <tr key={u.id} className="hover:bg-muted/20 transition-colors">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <div className="flex size-7 items-center justify-center rounded-full bg-muted text-muted-foreground border border-border/40">
                        <User size={13} />
                      </div>
          ...
          >
            <div className="space-y-4 flex-1">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={submitting}
                    className="h-9 w-full rounded-md border border-border bg-background pl-9 pr-3 text-xs outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary/20"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  disabled={submitting}
                  className="h-9 w-full rounded-md border border-border bg-background px-2.5 text-xs outline-none focus:border-primary focus:ring-1 focus:ring-primary/20"
                >
                  <option value="EDITOR">
            ...
            <div className="pt-4 border-t border-border flex justify-end gap-2">
              <button
                ...
                disabled={submitting}
                className="rounded-md border border-border px-4 py-2 text-xs font-semibold text-foreground hover:bg-muted disabled:opacity-50 cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-50 cursor-pointer active:translate-y-px transition-all"
              >
