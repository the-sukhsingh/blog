...
export default function TaxonomyDrawer({
  ...
  const handleDelete = async (
    ...
    if (!window.confirm(`Delete "${name}"? Posts using it won't be affected.`))
      return;
    setDeletingId(id);
    try {
      ...
      <Sheet open={open} onOpenChange={onOpenChange}>
        ...
        >
          <SheetHeader className="px-5 pt-5 pb-3">
            ...
            <SheetDescription>
              Create and manage categories &amp; tags without leaving the
              editor.
            </SheetDescription>
          </SheetHeader>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          void handleDelete(itemType, item.id, item.name)
                        }
                      >
                        {deletingId === item.id ? (
                          <Loader2 size={13} className="animate-spin" />
