...
export const Comment = (props: SVGProps<SVGSVGElement>, className?: string) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const Tag = (props: SVGProps<SVGSVGElement>, className?: string) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const Posts = (props: SVGProps<SVGSVGElement>, className?: string) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
